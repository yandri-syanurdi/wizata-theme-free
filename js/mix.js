    ...
    (i.VERSION = "3.3.2"),
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (p) {
            ...
            (a =
              "bottom" == a && h.bottom + c > g.bottom
                ? "top"
                : "top" == a && h.top - c < g.top
                ? "bottom"
                : "right" == a && h.right + d > g.width
                ? "left"
                : "left" == a && h.left - d < g.left
                ? "right"
                : a),
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        ...
        if (/right|left/.test(t)) {
          ...
          p < r.left
            ? (n.left = r.left - p)
            : h > r.width && (n.left = r.left + r.width - h);
        }
        return n;
      }),
          ...
          (s = h
            ...
            .each(function () {
              ...
              a._addClass(s, "ui-menu-icon", "ui-icon " + r),
                i.attr("aria-has ", "true").prepend(s),
 ...
 * jQuery Wizata
 */ function pilihharga() {
  var e = $('input[name="harpil"]:checked').val().split("|");
  (harga = parseInt(e[1])),
    (pilihan = e[0]),
    $("#guest").val("1"),
    $("#disc").val(""),
    $(".afterdiv").slideUp(),
    $(".b4div").animate({ "font-size": "100%" }).css("text-decoration", "none"),
    $("#hargatour").val(harga),
    $("#b4disc").val(harga),
    $(".hargapick").text(toRp(harga)),
    $(".pilihpick").text(pilihan),
    $("#pil").val(pilihan),
    $(".picked").slideDown();
}
function guestinput() {
  ...
  (hg = $("#hargatour").val()),
    "" == e
      ? $(".warningdate")
          .text("*Tentukan tanggal perjalanan terlebih dahulu.")
          .fadeIn()
          .delay("2000")
          .fadeOut()
      : "" == hg || "NaN" == hg
      ? $(".warningprice")
          .text("*Tentukan pilihan harga tour terlebih dahulu.")
          .fadeIn()
          .delay("2000")
          .fadeOut()
      : $(".pesan").fancybox({
  ...
  for (
    var a = document.getElementById("guest").value,
      t = document.getElementById("guestlist");
    t.hasChildNodes();

  )
    t.removeChild(t.lastChild);
  var n = ["Pilih", "Tuan", "Nyonya", "Nona"],
    l = ["", "Tuan", "Nyonya", "Nona"];
  for (i = 0; i < a; i++) {
    ...
    for (var d = 0; d < n.length; d++) {
      ...
      s.setAttribute("value", l[d]), (s.text = n[d]), r.appendChild(s);
    }
    var o = document.createElement("input");
    (o.type = "text"),
      (o.name = "nama1_guest[]"),
      (o.placeholder = "Masukkan nama depan");
    var u = document.createElement("input");
    (u.type = "text"),
      (u.name = "nama2_guest[]"),
      (u.placeholder = "Masukkan nama belakang");
    var c = document.createElement("div");
    c.style.clear = "both";
    var m = document.createElement("div");
    (m.className = "elementjudul"), (m.innerHTML = "Tamu " + (i + 1));
    var p = document.createElement("div");
    p.className = "elementgroup";
    var v = document.createElement("div");
    v.className = "elementwrap";
    var h = document.createElement("div");
    (h.className = "element1"), (h.innerHTML = "Titel");
    var g = document.createElement("div");
    (g.className = "element2"), (g.innerHTML = "Nama Depan");
    var f = document.createElement("div");
    (f.className = "element2"),
      (f.innerHTML = "Nama Belakang"),
      (h.appendChild(r).options[0].disabled = !0),
      g.appendChild(o),
      f.appendChild(u),
      v.appendChild(h),
      v.appendChild(g),
...
function guestinput_en() {
  var e = $("#datetour").val();
  (hg = $("#hargatour").val()),
    "" == e
      ? $(".warningdate")
          .text("*Please select date of trip first.")
          .fadeIn()
          .delay("2000")
          .fadeOut()
      : "" == hg || "NaN" == hg
      ? $(".warningprice")
          .text("*Please select the tour price option first.")
          .fadeIn()
          .delay("2000")
          .fadeOut()
      : $(".pesan").fancybox({
  ...
  for (
    var a = document.getElementById("guest").value,
      t = document.getElementById("guestlist_en");
    t.hasChildNodes();

  )
    t.removeChild(t.lastChild);
  var n = ["Choose", "Mr.", "Mrs.", "Ms."],
    l = ["", "Mr.", "Mrs.", "Ms."];
  for (i = 0; i < a; i++) {
    var r = document.createElement("select");
    r.name = "titel_guest[]";
    ...
    (o.type = "text"),
      (o.name = "nama1_guest[]"),
      (o.placeholder = "Input first name");
    var u = document.createElement("input");
    (u.type = "text"),
      (u.name = "nama2_guest[]"),
      (u.placeholder = "Input last name");
    var c = document.createElement("div");
    c.style.clear = "both";
    var m = document.createElement("div");
    (m.className = "elementjudul"), (m.innerHTML = "Guest " + (i + 1));
    var p = document.createElement("div");
    p.className = "elementgroup";
    var v = document.createElement("div");
    v.className = "elementwrap";
    var h = document.createElement("div");
    (h.className = "element1"), (h.innerHTML = "Title");
    var g = document.createElement("div");
    (g.className = "element2"), (g.innerHTML = "Fist Name");
    var f = document.createElement("div");
    (f.className = "element2"),
      (f.innerHTML = "Last Name"),
      (h.appendChild(r).options[0].disabled = !0),
      g.appendChild(o),
      f.appendChild(u),
      v.appendChild(h),
...
function copyCust(e) {
  if (e.checked) {
    var a = document.getElementsByName("titel_cust")[0].value;
    (nama1 = document.getElementsByName("nama1_cust")[0].value),
      (nama2 = document.getElementsByName("nama2_cust")[0].value);
  } else (a = ""), (nama1 = ""), (nama2 = "");
  (document.getElementsByName("titel_guest[]")[0].value = a),
    (document.getElementsByName("nama1_guest[]")[0].value = nama1),
    (document.getElementsByName("nama2_guest[]")[0].value = nama2);
}
function toRp(e, a, t, n, i) {
  for (
    a = (i = function (e) {
    ...
    (n += a[t]), (t + 1) % 3 == 0 && t !== a.length - 1 && (n += ".");
  return i(n);
}
function printDiv(e) {
  var a = document.getElementById(e).innerHTML,
    t = document.body.innerHTML;
  (document.body.innerHTML = a), window.print(), (document.body.innerHTML = t);
}
function refresh_captcha() {
  return (
    (document.getElementById("captcha_code").value = ""),
    document.getElementById("captcha_code").focus(),
    (document.images.captchaimg.src =
      document.images.captchaimg.src.substring(
        0,
        document.images.captchaimg.src.lastIndexOf("?")
      ) +
      "?rand=" +
      1e3 * Math.random())
  );
...
$(window).load(function () {
  $(".masonry").masonry({ singleMode: !0 });
}),
  $(window).scroll(function () {
    $(this).scrollTop() > 130
      ? $(".scrollup").fadeIn()
      : $(".scrollup").slideUp(150);
  }),
    ...
    $(".popi")
      ...
      $(function () {
        ...
        e.setDate(e.getDate() + 1),
          ...
          $("#datetour").datepicker({ dateFormat: "d MM yy", minDate: e }),
          $("#tabs").tabs();
      }),
      $("#slider,#gslider").owlCarousel({
        slideSpeed: 800,
        theme: "megaslider",
        autoPlay: !0,
      ...
      $("#testislider,#randomside").owlCarousel({
        theme: "smallslider",
        slideSpeed: 800,
        autoPlay: !0,
        paginationSpeed: 400,
      ...
      $("#sideup").click(function () {
        $(".sidecontain").toggle("fast");
      }),
      $(".disc").hover(function () {
        $(".disclist").slideToggle();
      }),
      $("#tourform").validate({
        ignore: ":not(:visible)",
        rules: {
          ...
          nama1_cust: "required",
          nama2_cust: "required",
          hp_cust: { required: !0, number: !0 },
          email_cust: { required: !0, email: !0 },
      ...
      $("#konform").validate({
        ...
        rules: {
          ...
          jmlh_transfer: { required: !0, number: !0 },
          rek_tujuan: "required",
          nama_cust: "required",
          hp_cust: { required: !0, number: !0 },
          email_cust: { required: !0, email: !0 },
      ...
      $("#guest").change(function () {
        ...
        (guest = $("#guest").val()),
          ...
          (b3 = parseInt(a3[0])),
          (c3 = parseInt(a3[1])),
          ("0" != b1) & (guest >= c1) & (guest < c2)
            ? ($("#hargatour").val(e - b1),
              $("#afterharga").text(toRp(e - b1)),
              $(".afterdiv").slideDown(),
              $(".b4div")
                .animate({ "font-size": "70%" })
                .css("text-decoration", "line-through"),
              $("#disc").val(toRp(b1)))
            : ("0" != b2) & (guest >= c2) & (guest < c3)
            ? ($("#hargatour").val(e - b2),
              $("#afterharga").text(toRp(e - b2)),
              $(".afterdiv").slideDown(),
              $(".b4div")
                .animate({ "font-size": "70%" })
                .css("text-decoration", "line-through"),
      ...
      $(".pesan").click(function () {
        var e = $("#datetour").val();
        (guest = $("#guest").val()),
          (harga = parseFloat($("#hargatour").val())),
          (hargatotal = guest * harga),
          $(".datetext").text(e),
          $("#dateval").val(e),
          $(".guesttext").text(guest),
          $("#guestval").val(guest),
          $("#hargatotal").val(hargatotal),
          $(".hargatotal").text(toRp(hargatotal)),
          $(".hargatour").text(toRp(harga)),
          $("#depe").val(hargatotal),
          $("#sdepe").val(hargatotal),
          $("#dp").val("100");
      }),
      $(".btn-number").click(function (e) {
        ...
        isNaN(t)
          ? a.val(0)
          : "minus" == type
          ? (t > a.attr("min") && a.val(t - 1).change(),
            parseInt(a.val()) == a.attr("min") && $(this).attr("disabled", !0))
          : "plus" == type &&
            (t < a.attr("max") && a.val(t + 1).change(),
            parseInt(a.val()) == a.attr("max") && $(this).attr("disabled", !0));
      }),
      ...
      $(".input-number").change(function () {
        (minValue = parseInt($(this).attr("min"))),
          ...
          valueCurrent >= minValue
            ...
            : (alert(
                "Maaf, minimal jumlah pemesanan adalah " + minValue + " pax"
              ),
          ...
          valueCurrent <= maxValue
            ...
            : (alert(
                "Maaf, maximal jumlah pemesanan adalah " + maxValue + " pax"
              ),
              $(this).val($(this).data("oldValue")));
      }),
      $("#dp").change(function () {
        var e = parseFloat($("#hargatotal").val());
        (persen = parseFloat($("#dp").val())),
          (depe = (e * persen) / 100),
          (sdepe = e - depe),
          $("#depe").val(depe),
          $("#sdepe").val(sdepe);
...
var adjustMenu = function () {
  768 > ww
    ? ($(".toggleMenu").hasClass("active")
        ? $(".naviku").show()
        : $(".naviku").hide(),
      $(".naviku li").unbind("mouseenter mouseleave"),
      $(".naviku li a.parent")
        .unbind("click")
    ...
    : ww >= 768 &&
      ($(".naviku").show(),
      $(".naviku li").removeClass("hover"),
      $(".naviku li a").unbind("click"),
      $(".naviku li")
